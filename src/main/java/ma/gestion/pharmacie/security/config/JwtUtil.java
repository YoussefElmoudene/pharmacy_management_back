...
import ma.gestion.pharmacie.security.filter.JwtConstant;
...
public class JwtUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(userDetails.getUsername()).setIssuedAt(new Date(System.currentTimeMillis())).setExpiration(new Date(System.currentTimeMillis() + JwtConstant.JWT_TOKEN_VALIDITY * 1000)).signWith(SignatureAlgorithm.HS512, secretKey).compact();
    }
